...
public partial class CrudPruebaContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            var connectionString = "DefaultConnection"; // Si deseas que sea por defecto si no se configura
                                                                  // Puedes obtener la cadena de conexión de la configuración (appsettings.json)
                                                                  // Si no tienes acceso al servicio de configuración aquí, puedes omitir este bloque
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdAnime).HasName("PK__Animes__A4BCC06A0BFA4EB7");
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__CD54BC5A04EF5F80");
        ...
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__Clientes__677F38F5B08E5735");
        ...
        {
            entity.HasKey(e => e.IdComentario).HasName("PK__Comentar__1BA6C6F4CCAE41EC");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__Empleado__88B513948204F1A5");
        ...
        {
            entity.HasKey(e => e.IdPrestamo).HasName("PK__Prestamo__5E87BE27DFFD7906");
